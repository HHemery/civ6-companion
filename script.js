    ...
    sections: [
      {
        ...
        blocs: [
          ...
          { ul: [
            ...
            "Changements 7.5 (surtout **systémiques**, peu de bascules civ par civ) : **culture encore buffée** (tourisme des chefs-d'œuvre en hausse) → les civs culture restent en haut ; **districts éco renforcés** (slots de spécialistes, Comptoir +1 adjacence du centre-ville, banques/bourses) + **Communisme +1 prod/citoyen** → léger up des civs wide/éco ; **recon buffé**, **unités aériennes −5 force** ; **victoire diplo accélérée** (1er congrès à l'ère médiévale, malus de doléances retirés) ; **score rééquilibré** (civics/techs priment sur les merveilles). Rien qui ne déclasse une civ d'un cran → c'est pourquoi le classement 7.4.x est reporté tel quel.",
